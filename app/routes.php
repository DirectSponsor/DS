...
Route::post('/forget', array('as'=>'users.forgetPasswordAction', 'uses' => 'UsersController@forgetPasswordAction'));
Route::get('/forgetConfirm/{token}', array('as'=>'users.forgetPasswordConfirmForm', 'uses' => 'UsersController@forgetPasswordConfirmForm'));
Route::post('/forgetConfirm/{token}', array('as'=>'users.forgetPasswordConfirmAction', 'uses' => 'UsersController@forgetPasswordConfirmAction'));
